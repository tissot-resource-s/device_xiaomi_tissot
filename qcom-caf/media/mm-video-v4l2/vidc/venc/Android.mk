...
libmm-venc-inc      += device/xiaomi/tissot/qcom-caf/media/mm-video-v4l2/vidc/common/inc
libmm-venc-inc      += device/xiaomi/tissot/qcom-caf/media/mm-core/inc
libmm-venc-inc      += device/xiaomi/tissot/qcom-caf/media/libstagefrighthw
libmm-venc-inc      += $(TARGET_OUT_HEADERS)/adreno
libmm-venc-inc      += device/xiaomi/tissot/qcom-caf/media/libc2dcolorconvert
libmm-venc-inc      += device/xiaomi/tissot/qcom-caf/media/hypv-intercept
